                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                <b>No podrás continuar si no se ha solicitado el 100% de las piezas.</b></small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="UnidadProgRampa" id="UnidadProgRampa" data-placeholder="Select UnidadProgRampa" >
                                    <option value=""></option>
                                    <option value="SI">SI</option>
                                    <option value="NO">NO</option>
                                    </select>
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="ReparacionUnidadPorcentaje" class="col-sm-2 control-label">Reparación Unidad % 
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ReparacionUnidadPorcentaje" id="ReparacionUnidadPorcentaje" placeholder="Reparación Unidad %" value="<?= set_value('ReparacionUnidadPorcentaje'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="Deducible" id="Deducible" data-placeholder="Select Deducible" >
                                    <option value=""></option>
                                    <option value="NO">NO</option>
                                    <option value="SI">SI</option>
                                    </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="MontoDeducible" id="MontoDeducible" placeholder="Monto Deducible" value="<?= set_value('MontoDeducible'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
