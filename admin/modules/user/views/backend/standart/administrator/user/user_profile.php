...
<div class="alert alert-info alert-dismissible">
                ...
                <h4><i class="icon fa fa-info"></i> Idioma</h4>
                Recuerda cambiar el idioma a español en la parte superior derecha.
              </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="box box-widget widget-user" >
                      ...
                      <div class="widget-user-image">
                        <img class="img-circle" src="<?= BASE_URL.'uploads/user/'.(!empty($user->avatar) ? $user->avatar :'default.png'); ?>" alt="Avatar" style="height: 80px; width: 80px" >
                      </div>
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="box box-widget widget-user-2">
                        <!-- Add the bg color to the header using any of the bg-* classes -->
                        <div class="">
                          <h3 class=""><?= cclang('detail_user') ?></h3>
                        </div>
                        <div class="box-footer no-padding">
                          <ul class="nav nav-stacked">
                   ...
                   <div class="row-fluid col-md-12" >
                        ...
                        <a class="btn btn-flat btn-info btn-warning btn_edit btn_action" id="btn_edit" data-stype='back' title="edit profile (Ctrl+e)" href="<?= site_url('administrator/user/edit_profile/'.$user->id); ?>"><i class="fa fa-edit" ></i><?= cclang('edit_profile') ?></a>
                        <?php }) ?>
                  </div>
